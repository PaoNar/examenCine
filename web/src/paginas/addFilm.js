                ...
                <div className="ml-64">
                    ...
                    <main className="my-8">
                        ...
                        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 mx-8" onSubmit={ this.saveData }>
                            ...
                            <div className="mt-4">
                                <button  onClick={() => window.location.assign("http://localhost:3000/films_room")}  className="    px-4 py-1 text-white font-light tracking-wider bg-gray-900 hover:bg-gray-800 rounded" type="submit">Guardar</button>
                            </div>
